...
public class DatePickerUtils implements View.OnClickListener, PickerView.OnSelectListener {
     ...
     */
    public DatePickerUtils(Context context, Callback callback, String beginDateStr, String endDateStr) {
     ...
     * @param context      Activity Context
     * @param callback     选择结果回调
     * @param beginDateStr 日期字符串
     * @param endDateStr   日期字符串
     * @param isPreciseTime 是否显示时分
     */
    public DatePickerUtils(Context context, Callback callback, String beginDateStr, String endDateStr, boolean isPreciseTime) {
     ...
     */
    public DatePickerUtils(Context context, Callback callback, long beginTimestamp, long endTimestamp) {
    ...
    private void initView() {
        ...
        mPickerDialog.setContentView(R.layout.layout_date_picker);
        ...
        mPickerDialog.findViewById(R.id.tv_commit).setOnClickListener(this);
